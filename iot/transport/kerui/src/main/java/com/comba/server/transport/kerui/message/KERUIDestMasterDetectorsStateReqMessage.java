...
/*
 * 
 * 获取目标主控器所有探测器状态	数据长度为0
 * 
 */
public class KERUIDestMasterDetectorsStateReqMessage extends KERUIAbstractMessage {

	public KERUIDestMasterDetectorsStateReqMessage() {
	...
	public String toString() {
		...
		return "KERUIDestMasterDetectorsStateReqMessage [packetHeader=" + ByteUtil.byteToHexString(getPacketHeader()) + ", version=" + getVersion() 
