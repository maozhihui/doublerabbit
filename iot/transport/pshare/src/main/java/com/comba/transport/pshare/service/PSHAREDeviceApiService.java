package com.comba.transport.pshare.service;
...
import com.comba.transport.pshare.service.session.TcpSessionCtx;
import com.comba.transport.pshare.service.session.TcpSessionId;

@Slf4j
@Service
public class PSHAREDeviceApiService {
    ...
    //设备注册
    public void register(IoSession session,String sessionId,String deviceSn,String json){
