...
public class CRC8 {
	...
	public static void main(String[] args) {
		...
		byte crc = CRC8.calcCrc8(new byte[] { (byte) 0xFF, 0x01, 0x41 });
		System.out.println("" + ByteUtil.byteToHexString(crc));
	}
}
