...
import com.comba.transport.daikin.service.session.TcpSessionCtx;
import com.comba.transport.daikin.service.session.TcpSessionId;

@Slf4j
@Service
public class DAIKINDeviceApiService {
