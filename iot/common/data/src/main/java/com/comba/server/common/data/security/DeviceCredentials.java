...
import com.comba.server.common.data.BaseData;
import com.comba.server.common.data.id.DeviceCredentialsId;
...
public class DeviceCredentials extends BaseData<DeviceCredentialsId> implements DeviceCredentialsFilter {
    ...
    public DeviceCredentials(String userName,String pwd){
    	super();
    	this.credentialsId = userName;
    	this.credentialsValue = pwd;
    	this.credentialsType = DeviceCredentialsType.USERNAME_PWD;
    }
