...
public class BasicAttributeKVMsg implements AttributesKVMsg {
    ...
    private final List<ConfigAttributes> attributes;
    public static BasicAttributeKVMsg from(List<ConfigAttributes> attributes) {
    	return new BasicAttributeKVMsg(attributes);
    }
