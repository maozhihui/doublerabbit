...
import com.comba.server.common.data.kv.Aggregation;
...
public class ModelConstants {
    ...
    public static UUID NULL_UUID = UUID.fromString("ffffffff-ffff-ffff-ffff-ffffffffffff");
    ...
    public static final String RULE_TENANT_ID_property = "tenant_id";
    ...
    public static final String RULE_PLUGIN_id_property = "plugin_id";
    public static final String RULE_FILTERS_property = "filters";
    public static final String RULE_PROCESSOR_property = "processor";
    public static final String RULE_ACTION_property = "action";
    public static final String RULE_additional_info_property = "additionalinfo";
    ...
    /**
     * Cassandra province constants
     */
    public static final String PROVINCE_COLUMN_FAMILY_NAME="province";    
    public static final String PROVINCE_CODE="province_code";
    public static final String PROVINCE_NAME="province_name";
    //public static final String PROVINCE_BY_SEARCH_TEXT="province_by_search_text";
    //public static final String PROVINCE_TENANT_ID=TENTANT_ID_PROPERTY;
    
    public static final String CITY_COLUMN_FAMILY_NAME="city";
    public static final String CITY_CODE="city_code";
    public static final String CITY_NAME="city_name";
    public static final String CITY_PROVINCE_ID="province_id";
    public static final String CITY_BY_SEARCH_TEXT="";
    public static final String CITY_BY_PROVINCE_ID_VIEW_NAME="city_by_province_id";
    
    public static final String AREA_COLUMN_FAMILY_NAME="area";
    public static final String AREA_CODE="area_code";
    public static final String AREA_NAME="area_name";
    public static final String AREA_CITY_ID="city_id";
    public static final String AREA_BY_CITY_ID_VIEW_NAME="area_by_city_id";
    /**
     ...
     * ctenant constants
     */
    public static final String CTENANT_TABLE_NAME = "tenant";
    public static final String CTENANT_ID_FIELD = "id";
    public static final String CTENANT_NAME_FIELD = "name";
    public static final String CTENANT_ADDITIONAL_INFO_FIELD = "additional_info";
    
    /**
     * config_attributes constants
     */
    /*public static final String config_attributes_table_name = "config_attributes";
    public static final String config_attributes_device_id_property = "dev_id";
    public static final String config_attributes_scope_property = "ATTRIBUTE_SCOPE";
    public static final String config_attributes_name_property = "ATTRIBUTE_NAME";
    public static final String config_attributes_name_property = "ATTRIBUTE_NAME";*/
