...
import com.comba.server.dao.common.utils.BeanUtils;
import com.comba.server.dao.common.utils.ReflectUtils;
...
public class HibernateGenericDao extends HibernateBasicDao {
	...
	private static Logger logger = Logger.getLogger(HibernateBasicDao.class);
    ...
    @Transactional(readOnly = true)
    public <T> List<T> findByIdsAndField(String field,Class<T> entityClass, List ids) {
        try {
             Criterion criterion = Restrictions.in(field, ids);
