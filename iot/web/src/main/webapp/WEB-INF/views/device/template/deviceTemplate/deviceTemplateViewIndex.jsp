	...
	<div class="page-container">
		<div id="myheading">
			<div class="content content-inner">
					...
					<div id="menu">
						<ul id="top_bar_ul" class="nav navbar-nav pull-left hidden-xs" style="background-color: #fff;border: 1px solid #4598E4;">
						 	<li class="tab_border_right  item_info">
								<a href="javascript:iframeByMenuUrl('${ctx}/deviceTemplate/to_deviceTemplate_view?deviceTemplateId=${deviceTemplate.deviceTemplateId }')" style="" class="team-status-toggle dropdown-toggle tip-bottom" data-toggle="tooltip" >
									<i class="fa fa-book"></i>
									<span class="tab_name">基本信息</span>
								</a>
						  	</li>
						    <li class="tab_border_right item_param">
								<a href="javascript:iframeByMenuUrl('${ctx}/attributesTemplate/list?isView=1&isTelemetry=0&deviceTemplateId=${deviceTemplate.deviceTemplateId }');" class="team-status-toggle dropdown-toggle tip-bottom " data-toggle="tooltip" >
									<i class="fa fa-cog"></i>
									<span class="tab_name">控制参数</span>
								</a>
							</li>
							<li class="tab_border_right">
								<a href="javascript:iframeByMenuUrl('${ctx}/attributesTemplate/list?isView=1&isTelemetry=1&deviceTemplateId=${deviceTemplate.deviceTemplateId }');" class="team-status-toggle dropdown-toggle tip-bottom" data-toggle="tooltip" >
				...
				<div class="info_main">
					<iframe src="${ctx}/deviceTemplate/to_deviceTemplate_view?deviceTemplateId=${deviceTemplate.deviceTemplateId }"  onload="/*changeCaseFrameHeight();*/" style="overflow:auto;height:100%" width="100%" id="deviceTemplateIframe" scrolling="no"  frameborder="0">
					</iframe>
				</div>
			</div>
		</div>
...
$(function(){
	if(getUrlParam("saveItem")){
		iframeByMenuUrl('${ctx}/attributesTemplate/list?isView=1&isTelemetry=0&deviceTemplateId=${deviceTemplate.deviceTemplateId }');
	}
	if(getUrlParam("saveItem")){
