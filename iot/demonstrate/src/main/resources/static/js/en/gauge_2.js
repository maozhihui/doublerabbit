...
function initBar(target,title){
	...
	$.ajax({
		...
		success: function (resp1) {
			...
			if(resp.currentValue != undefined){
	...
	var  optionBar = {
            ...
            legend: {
                data:['Current value','Average value'],
                top:20,
                left:'left',
...
initLine("lineWD",['Average value of temperature']);
initLine("lineSD",['Average value of humidity']);
initLine("linePM",['PM2.5 average value']);
initLine("linePH",['PH average value']);

initBar("barWD",'Area-temperature Top5');
initBar("barSD",'Area-humidity Top5');
