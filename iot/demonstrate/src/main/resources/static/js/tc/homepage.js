...
var height_2=$(window).height()/2-35;
//$("#mainBarAll,#mainBarCity,#mainBarAlert,#mainPie,#mainLine,#mainScroll").height(height);
$("#mainPie,#mainLine,#mainScroll").height(height);
$("#mainBarCity,#mainBarAlert").height(height_2);
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[300,160, 343, 135,154,117,310],
			//配置样式
            itemStyle: {   
                //通常情况下：
                normal:{  
                    color: function (params){
                        var colorList = ['RGB(187,163,153)','RGB(91,149,160)','RGB(43,137,227)','RGB(40,64,76)','RGB(192,126,40)','RGB(112,155,128)','RGB(136,188,166)'];
                        return colorList[params.dataIndex];
                    }
                }
            },
    ...
    series : [
        {
            ...
            center: ['50%', '60%'],
           data:[
                {value:135, name:'消防水泵控制器'},
                {value:200, name:'机械防排烟风机控制器'},
                {value:234, name:'联动控制器开关'},
                {value:135, name:'消防栓末端压力'},
                {value:248, name:'消防水箱容积'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
